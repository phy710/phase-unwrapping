...
subplot(3, 1, 1);
plot(f/1000000, phase*180/pi);
title('Phase (^o)');
xlabel('Frequency (MHz)');
grid on;
%% Unwrap the phase
unwrappedPhase = my_unwrap(phase);
%% Plot the unwrapped phase of the sound in frequency domain
subplot(3, 1, 2);
plot(f/1000000, unwrappedPhase*180/pi);
...
subplot(3, 1, 3);
plot(f/1000000, wrappedPhase*180/pi);
